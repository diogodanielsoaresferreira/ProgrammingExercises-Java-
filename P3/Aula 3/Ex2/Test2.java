...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(c1 + "tem area: " + c1.area() + " e perimetro: " + c1. per());
		System.out.println(c3 + "tem area: " + c3.area()+ " e perimetro: " + c3. per());
		...
		System.out.println(q1 + "tem area: " + q1.area()+ " e perimetro: " + q1.per());
		System.out.println(q3 + "tem area: " + q3.area()+ " e perimetro: " + q3.per());
		...
		System.out.println(r1 + "tem area: " + r1.area()+ " e perimetro: " + r1. per());
		System.out.println(r3 + "tem area: " + r3.area()+ " e perimetro: " + r3. per());
