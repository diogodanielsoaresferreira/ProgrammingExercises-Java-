...
public class Test3 {
	...
	public static void main(String[] args) {
		...
		File proxyList = new File("F:\\Programação\\Programas Diogo\\p3\\praticas\\aula12\\plugins");
		ArrayList<LoadSaveFile> plgs = new ArrayList<>();
		...
		Iterator<LoadSaveFile> it = plgs.iterator();
		while (it.hasNext()) {
			it.next().writeCont(dis);
		}
		
		it = plgs.iterator();
		while (it.hasNext()) {
			it.next().readCont(dis);
		}
